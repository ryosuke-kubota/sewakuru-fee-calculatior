...
function ReceiptContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 flex flex-col items-center">
      ...
      {/* アクションボタン */}
      <div className="flex space-x-2 mt-4 max-w-md mx-auto w-full">
        <button
          type="button"
        ...
        <Link
          href="/"
          className="flex-1 py-2 px-4 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 text-center"
        >
          メインページに戻る
        </Link>
      </div>
